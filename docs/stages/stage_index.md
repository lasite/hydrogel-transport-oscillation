...
| ----- | ------ | ----------- | --------- | ------------ | --------- |
| `G0_idea_brief` | active | Stable idea log, project brief, central hypothesis, open uncertainty list, and hardened GPT/Codex workflow protocol | `docs/stages/00_idea/gate.md` | G0 exit criteria and task/report protocol need hardening | Harden G0 gate, TASK template, CODEX-REPORT template, and scaffold verification |
...
| `G2_model` | paused | Candidate Model A summary and organized derivation | `docs/stages/02_model/gate.md` | G0 idea-brief protocol hardening is the active stage | Do not run model review until G0 exits and G2 is explicitly opened |
