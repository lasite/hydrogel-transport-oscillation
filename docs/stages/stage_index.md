...
| Model Specification | `G2_model` | active | Candidate Model A specification, sanity-check report, variable definitions, limiting cases, boundary-condition audit, and literature-risk-aligned mechanism tests | `docs/stages/02_model/gate.md` | Model A has not yet been sanity checked against novelty-risk constraints | Resolve model-specification blockers with concrete physics task names |
