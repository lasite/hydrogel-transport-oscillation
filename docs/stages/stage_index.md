...
| Model Specification | `G2_model` | active; replaced Appendix A--B derivation pending scientific review | Replaced Model A derivation; ChatGPT scientific review; reconciled candidate model specification; rebuilt blocker list; variable definitions; limiting cases; boundary-condition audit; material-function audit; minimum observables | `docs/stages/02_model/gate.md` | ChatGPT review of replaced Appendix A--B derivation and unresolved model-specification issues | Request ChatGPT Scientific Review of Replaced Model A Derivation |
