...
| Model Specification | `G2_model` | active; post-`paper_latest` source-material import and triage | Clean imported source material; reconciled candidate model specification; rebuilt blocker list; variable definitions; limiting cases; boundary-condition audit; material-function audit; minimum observables | `docs/stages/02_model/gate.md` | Migration-hygiene blockers and unreconciled Model A / migrated-draft model differences | Resolve `paper_latest` Migration Hygiene |
