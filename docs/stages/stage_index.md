...
| `G1_literature` | active | Populated novelty matrix and gap analysis | `docs/stages/01_literature/gate.md` | `docs/04_literature_map.md` is a template only | Populate literature map and novelty-risk matrix |
| `G2_model` | paused | Candidate Model A summary and organized derivation | `docs/stages/02_model/gate.md` | G1 literature mapping is active | Do not run model review until G1 exits and G2 is explicitly opened |
