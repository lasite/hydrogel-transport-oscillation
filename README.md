...
1. Insert the user's preliminary model derivation into `docs/derivations/initial_model_derivation.tex`.
2. Summarize the candidate model in `docs/model_candidates/model_A_initial_lcst_transport_barrier.md`.
3. Run `make quickcheck` and `make derivations`.
4. Complete `docs/tasks/exploration/EXP-001-ingest-initial-model.md`.
5. Produce a report under `docs/reports/exploration/`.
6. Run `EXP-002-sanity-check-candidate-model` before promoting any claim or model into `docs/validated/`.
